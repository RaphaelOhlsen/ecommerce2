...
public class CategoriaProdutoController {
  ...
  public ResponseEntity<List<CategoriaProduto>> buscarPorDesc(@RequestParam("desc") String desc, @RequestParam("idEmpresa") Long idEmpresa) throws ExceptionEcommerce {
    if (desc == null) {
  ...
  public ResponseEntity<CategoriaProdutoDTO> salvarCategoria(@RequestBody CategoriaProduto categoriaProduto) throws ExceptionEcommerce {
    ...
    if (categoriaProduto.getId() == null && categoriaProdutoRepository.existeCategoria(categoriaProduto.getNomeDesc(), categoriaProduto.getEmpresa().getId())) {
